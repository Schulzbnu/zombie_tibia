...
This information is pulled from [const.h](https://github.com/otland/forgottenserver/blob/master/src/const.h)
### Available constants:
...
##### MagicEffect
> **Description:** Sample usage: Sending [magic effects](Metatable:Position#sendMagicEffect).   
> **List:** 
```cpp
...
##### ShootType
> **Description:** Sample usage: Sending [distance effects](Metatable:Position#sendDistanceEffect).   
> **List:** 
```cpp
...
##### TalkType
> **Description:** Sample usage: Sending [Private Message](Metatable:Player#sendPrivateMessage).   
> **List:** 
```cpp
...
##### Message
> **Description:** Sample usage: Sending [Text Message](Metatable:Player#sendTextMessage).   
> **List:** 
```cpp
...
##### Item
> **Description:** A small selection of common item id's are available as enums.   
> **List:** 
```cpp
