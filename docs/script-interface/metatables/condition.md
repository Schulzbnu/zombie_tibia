...
[setOutfit(lookTypeEx, lookType, lookHead, lookBody, lookLegs, lookFeet, lookAddons, lookMount)](#setOutfit{lookTypeEx,lookType,lookHead,lookBody,lookLegs,lookFeet})  
...
<a name="setOutfit{lookTypeEx,lookType,lookHead,lookBody,lookLegs,lookFeet}"/>
