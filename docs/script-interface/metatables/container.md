...
### Available methods:
[addItem(itemId, count/subType = 1, index = INDEX_WHEREEVER, flags = 0)](#addItem)  
[addItemEx(item, index = INDEX_WHEREEVER, flags = 0)](#addItemEx)  
[getCapacity()](#getCapacity{})  
[getEmptySlots(recursive = false)](#getEmptySlots)  
